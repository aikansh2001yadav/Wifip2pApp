...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            Log.d("P2P_STATE", "P2P state changed - state:" + state);
            ...
            Log.d("P2P_STATE", "P2P peers changed");
            ...
            Log.d("P2P_STATE", "P2P connection changed - networkInfo:" + networkInfo.toString());
        	...
        	netService.updateThisDevice((WifiP2pDevice) intent.getParcelableExtra(
                    WifiP2pManager.EXTRA_WIFI_P2P_DEVICE));
            Log.d("P2P_STATE", "P2P this device changed - wifiP2pDevice:" + wifiP2pDevice.toString());
...
//            If the application tries to re-initiate discovery during this time, it can fail.
    		...
    		// ����ע��һ���Ƿ���������֪ͨ��
        	Log.d("P2P_STATE", "Other P2P change action - " + action);
    	}
    }
}